  ...
  <div class="form-div">
    <img class="logo_big" src="../assets/logo.png">
     <form class="form">
        ...
        <p>
            <button class="form_btn" type="button" v-on:click="signUp">Зарегестрироваться</button>
        </p>
      </form>
  </div>
</template>
...
export default {
  methods: {
    signUp() {
      ...
      const regLogin :HTMLInputElement = document.getElementById('login-text') as HTMLInputElement;
